...
CMD echo "deb http://${REPO_HOSTNAME:-git-lfs.github.com}/debian/8 jessie main" > /etc/apt/sources.list.d/git-lfs-main.list && \
    (wget -P /tmp/ http://${REPO_HOSTNAME:-git-lfs.github.com}/debian/8/GPG-KEY-GITLFS || :) && \
